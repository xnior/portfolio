export const arrayExperiences = [{
    summary:{
      strong: 'Systems Engineer',
      p: 'Projeto - Rockwell Collins Aviation',
      date: '2021 - 2021',
    ...
    //create for electrical engineering
    summary:{
      strong: 'Engenharia Elétrica',
      p: 'UNIUBE',
      date: '2017 - 2023',
      description: 'Como aluno concluinte do curso de Engenharia Elétrica, posso afirmar que a experiência foi enriquecedora e de grande relevância para minha trajetória profissional. Durante o programa, estive imerso em um ambiente educacional que equilibra teoria e prática, proporcionando uma compreensão abrangente dos desafios e oportunidades do setor elétrico brasileiro.',
      logo: 'assets/img/uniube.png'
    },text: 'Como aluno concluinte do curso de Engenharia Elétrica, posso afirmar que a experiência foi enriquecedora e de grande relevância para minha trajetória profissional. Durante o programa, estive imerso em um ambiente educacional que equilibra teoria e prática, proporcionando uma compreensão abrangente dos desafios e oportunidades do setor elétrico brasileiro.',
  },{
    ...
    //faça um texto semelhante ao da ANAC porém para FAA Estados Unidos
    summary:{
